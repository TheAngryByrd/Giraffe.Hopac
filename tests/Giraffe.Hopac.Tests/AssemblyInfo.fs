...
[<assembly: AssemblyTitleAttribute("Giraffe.Hopac.Tests")>]
[<assembly: AssemblyProductAttribute("Giraffe.Hopac")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "Giraffe.Hopac.Tests"
    let [<Literal>] AssemblyProduct = "Giraffe.Hopac"
